...
main = do
  ...
  probs :: ExampleParams ProbsRep <-
    sample
      (sampleProbs @ExampleParams prior)
      gen
  ...
  let tracesObs =
        [ Trace $ S.fromList [("coin", toDyn True), ("cat", toDyn (0 :: Int))]
        , Trace $ S.fromList [("coin", toDyn False), ("cat", toDyn (1 :: Int))]
        , Trace $ S.fromList [("coin", toDyn True), ("cat", toDyn (0 :: Int))]
        , Trace $ S.fromList [("coin", toDyn False), ("cat", toDyn (2 :: Int))]
        , Trace $ S.fromList [("coin", toDyn True), ("cat", toDyn (0 :: Int))]
        , Trace $ S.fromList [("coin", toDyn False), ("cat", toDyn (1 :: Int))]
        , Trace $ S.fromList [("coin", toDyn False), ("cat", toDyn (2 :: Int))]
        , Trace $ S.fromList [("coin", toDyn False), ("cat", toDyn (1 :: Int))]
